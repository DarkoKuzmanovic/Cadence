...
A reader[^1] suggested that the title README may be a playful nudge toward Lewis
...
before the rest of the directory's content[^2].
...
6. API formatting is highly bikesheddable. Use whatever format you think is
   ...
   e. aggressively linkify specialized terminology! In markdown you can keep
      ...
      found in [API formatting preferences](https://github.com/hackergrrl/common-readme/blob/master/api_formatting.md)
